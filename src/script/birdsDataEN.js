const birdsDataEN = [
  ...
  [
    ...
    },
    {
      ...
      description:
        'Thrush is the best singer from the sparrow squad. The song consists only of beautiful sonorous whistles and short trills. Most often it can be heard in the morning and evening. Thrushes sing during the entire nesting period.',
  ...
  [
    ...
    },
    {
      ...
      species: 'Apus apus',
      description:
        'Swift can be seen almost anywhere in the world. They live both in forest areas and in open places. Swifts live in disappeared flocks. Large colonies of these birds can be seen in cities or on attacking cliffs.',
  ...
  [
    ...
    },
    {
      ...
      description:
        'Starlings are migratory birds. Synchronous flight of large flocks of starlings is called murmuration. This beautiful and mesmerizing phenomenon is a spectacle of dancing bursts that form intricate shapes that shrink and grow in the sky.',
  ...
  [
    ...
    },
    {
      ...
      description:
        'The sizes of petrels are different. The smallest of them are up to 25 cm long, the largest - up to 1 m, with a wingspan of about 2 m. There is a belief that the appearance of a petrel in the air portends a storm, as the very name of the bird says.',
